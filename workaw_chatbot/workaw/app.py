...
available_models = [
    "gemini-1.5-flash",       # ลองชื่อมาตรฐานก่อน
    "gemini-1.5-flash-latest",# ชื่อ Alias ล่าสุด
    "gemini-1.5-flash-001",   # ชื่อระบุเวอร์ชัน (เสถียรสุด)
    "gemini-1.5-flash-002",   # เวอร์ชันใหม่กว่า
    "gemini-1.5-pro",         # ถ้า Flash ไม่ได้ ลอง Pro
    "gemini-1.5-pro-001",
